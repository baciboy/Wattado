...
export const LoginPage: React.FC = () => {
  ...
  <h1 className="text-3xl font-bold text-blue-800 mb-6 text-center">Sign In to Wattado</h1>
        ...
        {selectedTab === "email" ? (
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); }}>
            <div>
              ...
              <div className="flex">
                <select className="px-2 py-2 border border-gray-300 rounded-l-lg bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <input
                  type="tel"
                  className="w-full px-3 py-2 border-t border-b border-r border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <button
              type="submit"
              className="w-full py-2 mt-2 bg-blue-700 text-white rounded-lg font-semibold opacity-70 cursor-not-allowed"
